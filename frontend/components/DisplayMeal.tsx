...
const DisplayMeal = (props: DisplayMealProps) => {
  ...
  return (
    ...
    display: 'flex',
    alignItems:'center',
    height: height > width ? 0.70 * height : 0.02 * height, 
    borderRadius: 0.05 * width,
    borderWidth: 0.02 * width,
    borderColor: 'blue'
    }}>
        {/* TODO: Update UI here to use relative terms instead of absolute */}
      <View style={{ display:'flex', flexDirection: "column", justifyContent: 'space-evenly', padding: 30, alignItems: 'center' }}>
          <Image source={{ uri: `${props.photolink}` }}  style={{ width: 200, height: 200 }}></Image>
